...
type RsiData = { value: number; status: string };
type MacdData = { value: number; signal: number; histogram: number; status: string };
...
const defaultData: TechnicalIndicatorsData = {
  ...
  macd: { value: 0.0015, signal: 0.0010, histogram: 0.0005, status: 'Uptrend' },
};
      ...
      <div className="space-y-6">
        <div>
          ...
          <div className="flex justify-between text-xs text-muted-foreground mt-1">
           ...
           <p className="text-xs text-muted-foreground mt-1 text-center">Placeholder data</p>
        </div>
